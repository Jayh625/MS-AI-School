...
def main() :
    ...
    num_features = 1280
    model.classifier[1] = nn.Linear(num_features, 100)
    model.to(device)
    model.load_state_dict(torch.load(f="./result1/20230719_092705/efficientnet_v2_s_best.pt"))
    ...
    test_dataset = CustomDataset("./data/sport_dataset/test", transform=val_transforms)
    test_loader = DataLoader(test_dataset, batch_size=1, shuffle=False)

    model.to(device)
    model.eval()
    correct = 0 
    data_dir = "./data/sport_dataset/test"
    dict = {}

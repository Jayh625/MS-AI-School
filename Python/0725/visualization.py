...
def draw_boxes_on_image(image_file, annotation_file) :
    ...
    # txt file read
    with open(annoation_file, 'r', encoding='utf-8') as f :
        lines = f.readlines()
    ...
    for line in lines :
        ...
        cv2.putText(image, str(class_id), (x_min, y_min-5), cv2.FONT_HERSHEY_PLAIN, 5, (0,255,0))
...
if __name__ == "__main__" :
    ...
    annoation_file = "./dataset/train/syn_00025.txt"

    draw_boxes_on_image(image_file, annoation_file)
...
def main() :
    ...
    def train(model, train_loader, optimizer, scheduler, device, resume_checkpoint=None) :
        ...
        for epoch in range(start_epoch, config['EPOCHS'] + 1) :
            ...
            for batch_idx, (images, targets) in enumerate(tqdm(train_loader, total=num_batches, desc=f"Epoch [{epoch}] Batches", leave=True, mininterval=0)) :
    ...
    train(model, train_loader, optimizer, scheduler, device, resume_checkpoint="./checkpoint.pt")

...
def main() :
    ...
    model.to(device)
    model.load_state_dict(torch.load(f="./data/best2.pt"))
    ...
    test_dataset = CustomDataset("./data/fold/val/", transform=val_transforms)
    test_loader = DataLoader(test_dataset, batch_size=1, shuffle=False)

    model.to(device)
    model.eval()
    correct = 0 
    data_dir = "./data/fold/val/"
    dict = {}

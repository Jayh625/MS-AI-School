...
def main() :
    ...
    # dataloaders
    train_loader = DataLoader(train_dataset, batch_size=512, num_workers=4, pin_memory=True, shuffle=True)
    val_loader = DataLoader(val_dataset, batch_size=512, num_workers=4, pin_memory=True, shuffle=False)
